...
javac -classpath hadoop-1.2.1/hadoop-core-1.2.1.jar:hadoop-1.2.1/lib/commons-cli-1.2.jar:playground/classes -d playground/classes/ playground/src/TweetCategorizer.java
