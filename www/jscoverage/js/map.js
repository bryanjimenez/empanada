  ...
  if (((xmlHttp.readyState == 4) && (xmlHttp.status == 200))) {
    ...
    for (var key in icons) {
      ...
      if ((prefilters && (prefilters.indexOf(key) < 0))) {
        ...
        _$jscoverage['js/map.js'][172]++;
        _this.remove(key);
      }
      else {
        _$jscoverage['js/map.js'][174]++;
      ...
      _$jscoverage['js/map.js'][176]++;
      parent.appendChild(div);
}
  }
});
  _$jscoverage['js/map.js'][180]++;
  xmlHttp.open("GET", jsonF, true);
  _$jscoverage['js/map.js'][181]++;
  xmlHttp.send(null);
}
_$jscoverage['js/map.js'][184]++;
function User() {
  _$jscoverage['js/map.js'][185]++;
  var _this = this;
}
_$jscoverage['js/map.js'][191]++;
var places;
_$jscoverage['js/map.js'][192]++;
function Places() {
  _$jscoverage['js/map.js'][195]++;
  this.searchNear = (function (obj) {
  _$jscoverage['js/map.js'][196]++;
  var request = {location: new (google.maps.LatLng)(lat, lng), radius: 500, keyword: obj.value};
  _$jscoverage['js/map.js'][203]++;
  var service = new (google.maps.places.PlacesService)(map);
  _$jscoverage['js/map.js'][204]++;
  service.nearbySearch(request, callback);
});
  _$jscoverage['js/map.js'][207]++;
  function callback(results, status) {
    _$jscoverage['js/map.js'][208]++;
    if ((status == google.maps.places.PlacesServiceStatus.OK)) {
      _$jscoverage['js/map.js'][209]++;
      for (var i = 0; (i < results.length); (i++)) {
        _$jscoverage['js/map.js'][210]++;
        var request = {reference: results[i].reference};
        _$jscoverage['js/map.js'][213]++;
        service = new (google.maps.places.PlacesService)(map);
        _$jscoverage['js/map.js'][214]++;
        service.getDetails(request, callback_detail);
}
    }
}
  _$jscoverage['js/map.js'][218]++;
  function callback_detail(place, status) {
    _$jscoverage['js/map.js'][219]++;
    if ((status == google.maps.places.PlacesServiceStatus.OK)) {
      _$jscoverage['js/map.js'][220]++;
      createMarker(place);
    }
}
  _$jscoverage['js/map.js'][225]++;
  function createMarker(place) {
    _$jscoverage['js/map.js'][226]++;
    ...
    _$jscoverage['js/map.js'][248]++;
    var marker = new (google.maps.Marker)({map: map, icon: image, position: place.geometry.location});
    _$jscoverage['js/map.js'][254]++;
    google.maps.event.addListener(marker, "click", (function () {
  _$jscoverage['js/map.js'][255]++;
  Markers.window.setContent(contentString);
  _$jscoverage['js/map.js'][256]++;
  Markers.window.open(map, this);
}));
}
}
_$jscoverage['js/map.js'][263]++;
var compass;
_$jscoverage['js/map.js'][264]++;
function Compass(obj) {
  _$jscoverage['js/map.js'][265]++;
  var _this = this;
  _$jscoverage['js/map.js'][266]++;
  var mymarker;
  _$jscoverage['js/map.js'][267]++;
  var watching = null;
  _$jscoverage['js/map.js'][269]++;
  this.status = (function () {
  _$jscoverage['js/map.js'][270]++;
  return (watching != null);
});
  _$jscoverage['js/map.js'][274]++;
  var needle_off = "image/arrow_off.png";
  _$jscoverage['js/map.js'][275]++;
  var needle_on = "image/arrow_on.png";
  _$jscoverage['js/map.js'][276]++;
  this.htmlObj = obj;
  _$jscoverage['js/map.js'][278]++;
  this.htmlObj.onclick = (function () {
  _$jscoverage['js/map.js'][279]++;
  _this.toggle();
});
  _$jscoverage['js/map.js'][286]++;
  this.dropPin = (function (t) {
  _$jscoverage['js/map.js'][288]++;
  if (((! t) && mymarker)) {
    _$jscoverage['js/map.js'][289]++;
    mymarker.setMap(null);
  }
  else {
    _$jscoverage['js/map.js'][291]++;
    map.setCenter(mypos);
    _$jscoverage['js/map.js'][293]++;
    if (mymarker) {
      _$jscoverage['js/map.js'][294]++;
      mymarker.setMap(null);
    }
    _$jscoverage['js/map.js'][296]++;
    mymarker = new (google.maps.Marker)({position: mypos, map: map, icon: "image/red.png", title: "You're Here"});
  }
});
  _$jscoverage['js/map.js'][309]++;
  var options = {enableHighAccuracy: true, timeout: 5000, maximumAge: 0};
  _$jscoverage['js/map.js'][315]++;
  function success(pos) {
    _$jscoverage['js/map.js'][316]++;
    lat = pos.coords.latitude;
    _$jscoverage['js/map.js'][317]++;
    lng = pos.coords.longitude;
    _$jscoverage['js/map.js'][318]++;
    mypos = new (google.maps.LatLng)(lat, lng);
    _$jscoverage['js/map.js'][319]++;
    _this.dropPin(true);
}
  _$jscoverage['js/map.js'][322]++;
  function error(err) {
    _$jscoverage['js/map.js'][323]++;
    var msg;
    _$jscoverage['js/map.js'][325]++;
    switch (error.code) {
    case error.PERMISSION_DENIED:
      _$jscoverage['js/map.js'][328]++;
      msg = "User denied the request for Geolocation.";
      _$jscoverage['js/map.js'][329]++;
      break;
    case error.POSITION_UNAVAILABLE:
      _$jscoverage['js/map.js'][331]++;
      msg = "Location information is unavailable.";
      _$jscoverage['js/map.js'][332]++;
      break;
    case error.TIMEOUT:
      _$jscoverage['js/map.js'][334]++;
      msg = "The request to get user location timed out.";
      _$jscoverage['js/map.js'][335]++;
      break;
    case error.UNKNOWN_ERROR:
      _$jscoverage['js/map.js'][337]++;
      msg = "An unknown error occurred.";
      _$jscoverage['js/map.js'][338]++;
      break;
    }
    _$jscoverage['js/map.js'][340]++;
    _this.off();
    _$jscoverage['js/map.js'][343]++;
    alert("Geolocation is not supported by your browser at this time.");
}
  _$jscoverage['js/map.js'][346]++;
  ;
  _$jscoverage['js/map.js'][348]++;
  this.off = (function () {
  _$jscoverage['js/map.js'][349]++;
  _this.htmlObj.style.backgroundImage = ("url('" + needle_off + "')");
  _$jscoverage['js/map.js'][351]++;
  navigator.geolocation.clearWatch(watching);
  _$jscoverage['js/map.js'][352]++;
  watching = null;
  _$jscoverage['js/map.js'][353]++;
  _this.dropPin(false);
});
  _$jscoverage['js/map.js'][356]++;
  this.toggle = (function () {
  _$jscoverage['js/map.js'][358]++;
  if ((watching != null)) {
    _$jscoverage['js/map.js'][359]++;
    _this.htmlObj.style.backgroundImage = ("url('" + needle_off + "')");
    _$jscoverage['js/map.js'][360]++;
    navigator.geolocation.clearWatch(watching);
    _$jscoverage['js/map.js'][361]++;
    watching = null;
    _$jscoverage['js/map.js'][362]++;
    _this.dropPin(false);
  }
  else {
    _$jscoverage['js/map.js'][366]++;
    _this.htmlObj.style.backgroundImage = ("url('" + needle_on + "')");
    _$jscoverage['js/map.js'][367]++;
    watching = navigator.geolocation.watchPosition(success, error, options);
  }
});
}
_$jscoverage['js/map.js'][374]++;
var Map = {rad2zoom: (function (radius) {
  _$jscoverage['js/map.js'][386]++;
  return Math.round((14 - (Math.log(radius) / Math.LN2)));
}), zoom2rad: (function (zoom) {
  _$jscoverage['js/map.js'][389]++;
  return Math.pow(2, (14 - zoom));
}), codeAddress: (function (address) {
  _$jscoverage['js/map.js'][400]++;
  geocoder.geocode({"address": address}, (function (results, status) {
  _$jscoverage['js/map.js'][401]++;
  if ((status == google.maps.GeocoderStatus.OK)) {
    _$jscoverage['js/map.js'][403]++;
    mypos = results[0].geometry.location;
    _$jscoverage['js/map.js'][404]++;
    map.setCenter(mypos);
    _$jscoverage['js/map.js'][405]++;
    update();
  }
  else {
    _$jscoverage['js/map.js'][408]++;
    alert(("Geocode was not successful for the following reason: " + status));
  }
}));
})};
_$jscoverage['js/map.js'][416]++;
function update() {
  _$jscoverage['js/map.js'][418]++;
  var xmlHttp = new XMLHttpRequest();
  _$jscoverage['js/map.js'][420]++;
  xmlHttp.onreadystatechange = (function () {
  _$jscoverage['js/map.js'][422]++;
  if (((xmlHttp.readyState == 4) && (xmlHttp.status == 200) && xmlHttp.responseText)) {
    _$jscoverage['js/map.js'][427]++;
    var tweets = JSON.parse(xmlHttp.responseText);
    _$jscoverage['js/map.js'][429]++;
    if ((tweets.t != null)) {
      _$jscoverage['js/map.js'][430]++;
      (LOG && console.log(("Results: " + tweets.t.length)));
    }
    _$jscoverage['js/map.js'][434]++;
    for (var i in tweets.t) {
      _$jscoverage['js/map.js'][437]++;
      var filter = tweets.f[i];
      _$jscoverage['js/map.js'][438]++;
      var tweet = tweets.t[i];
      _$jscoverage['js/map.js'][439]++;
      var rank = tweets.r[i];
      _$jscoverage['js/map.js'][441]++;
      var user = tweet.user.screen_name;
      _$jscoverage['js/map.js'][442]++;
      var pic = tweet.user.profile_image_url;
      _$jscoverage['js/map.js'][443]++;
      var text = tweet.text;
      _$jscoverage['js/map.js'][444]++;
      var follow = tweet.user.followers_count;
      _$jscoverage['js/map.js'][445]++;
      var friends = tweet.user.friends_count;
      _$jscoverage['js/map.js'][446]++;
      var c = new Date(tweet.created_at);
      _$jscoverage['js/map.js'][452]++;
      if ((tweet.created_at.indexOf("lastUpdated :") < 0)) {
        _$jscoverage['js/map.js'][453]++;
        var d = c.toDateString().split(" ");
        _$jscoverage['js/map.js'][454]++;
        var t = c.toLocaleTimeString().split(":");
        _$jscoverage['js/map.js'][455]++;
        var ampm = c.toLocaleTimeString().split(" ")[1];
        _$jscoverage['js/map.js'][456]++;
        var created = (d[0] + ", " + d[1] + " " + d[2] + " " + t[0] + ":" + t[1] + " " + ampm);
      }
      else {
        _$jscoverage['js/map.js'][459]++;
        var created = "";
        _$jscoverage['js/map.js'][460]++;
        text = (text.split("**")[0] + text.split("**")[1] + text.split("**")[3]);
      }
      _$jscoverage['js/map.js'][464]++;
      if (tweet.geo) {
        _$jscoverage['js/map.js'][465]++;
        var x = tweet.geo.coordinates[0];
        _$jscoverage['js/map.js'][466]++;
        var y = tweet.geo.coordinates[1];
      }
      else {
        _$jscoverage['js/map.js'][470]++;
        var x = 25.758102000000001;
        _$jscoverage['js/map.js'][471]++;
        var y = -80.373632999999998;
      }
      _$jscoverage['js/map.js'][476]++;
      ...
      _$jscoverage['js/map.js'][533]++;
      if ((manager.getMarker(x, y, 0) == null)) {
        _$jscoverage['js/map.js'][534]++;
        Markers.push(marker, filter, contentString);
        _$jscoverage['js/map.js'][535]++;
        manager.addMarker(marker, 0);
        _$jscoverage['js/map.js'][536]++;
        manager.refresh();
      }
      else {
      }
  ...
  _$jscoverage['js/map.js'][545]++;
  lat = map.getCenter().lat();
  _$jscoverage['js/map.js'][546]++;
  lng = map.getCenter().lng();
  _$jscoverage['js/map.js'][547]++;
  zoom = map.getZoom();
  _$jscoverage['js/map.js'][550]++;
  rad = Map.zoom2rad(zoom);
  _$jscoverage['js/map.js'][555]++;
  var s = (refresh + "?lat=" + lat + "&lng=" + lng + "&rad=" + rad + "&filter=" + legend.getFilters());
  _$jscoverage['js/map.js'][556]++;
  (LOG && console.log(("Request: " + s)));
  _$jscoverage['js/map.js'][563]++;
  xmlHttp.open("GET", s, true);
  _$jscoverage['js/map.js'][564]++;
  xmlHttp.send(null);
}
_$jscoverage['js/map.js'][573]++;
function tagAnchors(s) {
  _$jscoverage['js/map.js'][574]++;
  var p = /https?:[^( |,|\u00e2\u0080\u009d|\u00e2\u0080\u009c|")]*/g;
  _$jscoverage['js/map.js'][576]++;
  if (p.test(s)) {
    _$jscoverage['js/map.js'][577]++;
    s = s.replace(p, "<a href=$& target='_blank'>$&</a>");
  }
  _$jscoverage['js/map.js'][580]++;
  return s;
}
_$jscoverage['js/map.js'][583]++;
function vote(x, y) {
  _$jscoverage['js/map.js'][586]++;
  var m = manager.getMarker(x, y, 0);
  _$jscoverage['js/map.js'][587]++;
  m.setMap(null);
  _$jscoverage['js/map.js'][588]++;
  manager.removeMarker(m);
  _$jscoverage['js/map.js'][589]++;
  manager.refresh();
}
_$jscoverage['js/map.js'][616]++;
function showSearch(t) {
  _$jscoverage['js/map.js'][617]++;
  document.getElementById("detail").style.visibility = ((t == true)? "": "hidden");
}
_$jscoverage['js/map.js'][628]++;
function initialize() {
  _$jscoverage['js/map.js'][632]++;
  compass = new Compass(document.getElementById("compass"));
  _$jscoverage['js/map.js'][633]++;
  places = new Places();
  _$jscoverage['js/map.js'][634]++;
  geocoder = new (google.maps.Geocoder)();
  _$jscoverage['js/map.js'][635]++;
  legend = new Legend(document.getElementById("legend"));
  _$jscoverage['js/map.js'][639]++;
  if ((location.search.indexOf("raw=") > -1)) {
    _$jscoverage['js/map.js'][640]++;
    refresh = ((location.search.split("raw=")[1].split("&")[0] == "true")? "raw.php": refresh);
  }
  _$jscoverage['js/map.js'][641]++;
  if ((location.search.indexOf("lat=") > -1)) {
    _$jscoverage['js/map.js'][642]++;
    lat = location.search.split("lat=")[1].split("&")[0];
  }
  _$jscoverage['js/map.js'][643]++;
  if ((location.search.indexOf("lng=") > -1)) {
    _$jscoverage['js/map.js'][644]++;
    lng = location.search.split("lng=")[1].split("&")[0];
  }
  _$jscoverage['js/map.js'][645]++;
  if ((location.search.indexOf("filter=") > -1)) {
    _$jscoverage['js/map.js'][646]++;
    legend.setPreFilters(location.search.split("filter=")[1].split("&")[0]);
  }
  _$jscoverage['js/map.js'][647]++;
  if ((location.search.indexOf("zoom=") > -1)) {
    _$jscoverage['js/map.js'][648]++;
    zoom = parseInt(location.search.split("zoom=")[1].split("&")[0]);
  }
  _$jscoverage['js/map.js'][649]++;
  if ((location.search.indexOf("live=") > -1)) {
    _$jscoverage['js/map.js'][650]++;
    live = (location.search.split("live=")[1].split("&")[0] == "true");
  }
  _$jscoverage['js/map.js'][651]++;
  if ((location.search.indexOf("log=") > -1)) {
    _$jscoverage['js/map.js'][652]++;
    LOG = (location.search.split("log=")[1].split("&")[0] == "true");
  }
  _$jscoverage['js/map.js'][657]++;
  ...
  _$jscoverage['js/map.js'][664]++;
  map = new (google.maps.Map)(document.getElementById("map-canvas"), mapOptions);
  _$jscoverage['js/map.js'][667]++;
  var mgrOptions = {borderPadding: 0, maxZoom: 1};
  _$jscoverage['js/map.js'][668]++;
  manager = new MarkerManager(map, mgrOptions);
  _$jscoverage['js/map.js'][674]++;
  google.maps.event.addListener(map, "tilesloaded", (function () {
  _$jscoverage['js/map.js'][675]++;
  update();
  _$jscoverage['js/map.js'][676]++;
  garbagecollect();
}));
  _$jscoverage['js/map.js'][681]++;
  google.maps.event.addListener(map, "zoom_changed", (function () {
  _$jscoverage['js/map.js'][682]++;
  Markers.closeAll();
}));
  _$jscoverage['js/map.js'][684]++;
  google.maps.event.addListener(map, "dragend", (function () {
  _$jscoverage['js/map.js'][685]++;
  Markers.closeAll();
}));
  _$jscoverage['js/map.js'][688]++;
  google.maps.event.addListener(map, "click", (function () {
  _$jscoverage['js/map.js'][689]++;
  Markers.closeAll();
}));
  _$jscoverage['js/map.js'][695]++;
